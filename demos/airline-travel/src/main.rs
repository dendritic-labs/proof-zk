...
pub async fn create_government_passport_did(
    ...
    println!("Government Passport DID: {}", passport_identity.did);
    println!(
        "   Passport: {} ({})",
        passport_data.passport_number, passport_data.issuing_country
    );
...
pub async fn create_visa_did(
    ...
    println!("Visa DID: {}", visa_identity.did);
    println!(
        "   Visa: {} ({} → {})",
        visa_data.visa_number, issuing_country, destination_country
    );
...
async fn main() -> Result<()> {
    println!("ProofZK Airline Travel Demo with Government DIDs");
    println!("====================================================");
    ...
    println!("WestJet DID: {}", westjet_identity.did);
    ...
    let flight_request = AirlineProofRequest {
        ...
        required_proofs: vec![
            ...
            TravelProofType::VisaValid {
                destination: "United States".to_string(),
            },
            TravelProofType::AgeVerification { min_age: 18 },
            TravelProofType::Nationality {
                allowed_countries: vec!["Canada".to_string()],
            },
        ],
    ...
    println!(
        "   Flight: {} ({} → {})",
        flight_request.flight_number,
        flight_request.departure_country,
        flight_request.arrival_country
    );
    println!(
        "   Required proofs: {} items",
        flight_request.required_proofs.len()
    );
    ...
    let passport_wallet_cred = WalletCredential {
        ...
        public_key: passport_identity.document.public_keys[0]
            .public_key_base58
            .clone(),
        metadata: {
            ...
            meta.insert(
                ...
                "government_passport".to_string(),
            );
            meta.insert(
                "issuing_authority".to_string(),
                "Passport Canada".to_string(),
            );
    ...
    wallet_integration
        .register_wallet_credential(passport_wallet_cred)
        .await?;
    ...
    println!("   Visa validity: VERIFIED (without revealing visa details)");
    ...
    println!("   Verifier: {} (WestJet)", westjet_identity.did);
    println!("   Issuers: Government authorities");
    ...
    println!("   Government-issued credentials");
