...
async fn main() -> Result<()> {
    println!("✈️  ProofZK Airline Check-in Demo");
    println!("==================================");
    ...
    println!("🔒 App requests proof of age ≥ {} (no birthdate stored)", min_required_age);
    ...
    println!("   - Passenger age ≥ {}: {}", min_required_age, age_proof.is_over_age);
    ...
    let verification_result = verify_age_proof_complete(
        &age_proof,
        &wallet_response,
        min_required_age,
    ).await?;
    ...
    if verification_result {
        ...
        println!("✈️  Check-in approved!");
        println!("🗑️  Session data will auto-expire in 5 minutes");
    } else {
    ...
    println!("\n📊 Privacy Analysis:");
    println!("   ✅ Airline knows: Passenger is ≥ {} years old", min_required_age);
    ...
    let apple_config = wallet_integration.generate_apple_wallet_integration("did:proofzk:passenger123")?;
